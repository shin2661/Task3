...
<nav class="navbar navbar-expand-lg navbar-light">
	<div class="container px-4 px-lg-5">
		<a class="navbar-brand" href="${pageContext.request.contextPath}/main.do">Home</a>
		...
		<div class="navbar-collapse collapse" id="navbarSupportedContent" style="">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
				...
				<li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/counselList.do">글목록</a></li>
				<li class="nav-item"><a class="nav-link" href="secured/counselList.do">secured</a></li>
			...
			<div class="d-flex">
				...
				<sec:authorize access="isAuthenticated()">
					<sec:authorize access="hasRole('ADMIN')">
						<a class="nav-link link-body-emphasis px-2" href="${pageContext.request.contextPath }/admin/adminPage.do">관리자페이지</a>
					</sec:authorize>
